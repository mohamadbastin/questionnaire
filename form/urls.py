...
urlpatterns = [
    ...
    path('answered-form/', MyAnsweredFormsListView.as_view()),
    ...
    path('form/answered-forms/<int:fid>', FormAnsweredFormsListView.as_view()),
    path('form/answer/<int:fid>', FormAnswerCreate.as_view()),
    path('form/delete/<int:fid>', FormDeleteView.as_view()),
